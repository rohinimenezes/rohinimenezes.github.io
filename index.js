...
var base = Rebase.createClass({
  apiKey: " AIzaSyCDjJJcoyUHY27BdlxPX2_AyPTirOlgCEs",   // replace with your Firebase application's API key
  databaseURL: "https://buyflix-d348b.firebaseapp.com/",
})
...
var App = React.createClass({
  ...
  componentDidMount: function() {
    ...
    { context: this, state: 'movies', asArray: true })
  },
  render: function() {
    return (
      <div>
